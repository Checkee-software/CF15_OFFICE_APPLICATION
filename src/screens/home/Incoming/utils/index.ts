...
export type TFocusableIncomingField = 'title' | 'organization' | 'sender' | 'registeredNumber' | 'createdAt' | 'finishedAt';
...
export const INCOMING_LEVEL_ALLOWED_STATUSES: Record<TLevelKey, EDocumentStatus[]> = {
...
export const getIncomingCardAction = (status?: EDocumentStatus): TIncomingCardAction => {
...
export const buildCategoryPath = (leafId: string, byId: Record<string, any>) => {
  const path: string[] = [];
