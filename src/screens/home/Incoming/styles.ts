...
const styles = StyleSheet.create({
  ...
  dropdownSearchWrap: { height: 42, marginHorizontal: 10, marginVertical: 8, borderWidth: 1, borderColor: '#D9DDE3', borderRadius: 8, backgroundColor: '#F8F9FB', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10 },
  dropdownSearchInput: { flex: 1, height: 40, marginLeft: 8, color: '#222', fontSize: 14, paddingVertical: 0 },
  dropdownSearchClear: { width: 28, height: 28, alignItems: 'center', justifyContent: 'center' },
