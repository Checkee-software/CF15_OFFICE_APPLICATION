...
const styles = StyleSheet.create({
  ...
  dropdownMenu: { position: 'absolute', top: 48, left: 0, right: 0, backgroundColor: '#FFF', borderWidth: 1, borderColor: '#DCDCDC', borderRadius: 10, maxHeight: 220, zIndex: 100, elevation: 5 },
  dropdownMenuContainer: { backgroundColor: '#FFF', borderWidth: 1, borderColor: '#DCDCDC', borderRadius: 10, overflow: 'hidden' },
